...
function f(p, y) {
  const o = h[p].fontSize * y * 0.01;
  return Math.min(Math.round(o), t[p]);
}
function S({
  token: p,
  weight: y = "Regular",
  ...
  const { fontSize: s, lineHeight: e } = h[p], u = {
    fontSize: s,
    lineHeight: `${e}px`,
    fontWeight: i[y],
    color: g,
  ...
  return /* @__PURE__ */ b(o, { style: u, ...T, children: r });
}
export {
  S as Text,
  t as androidMaxFontSize,
  i as fontWeightMap,
  f as getAndroidFontSize,
  l as iosScaleTable,
  h as typographyTokens
};
